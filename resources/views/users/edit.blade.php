                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                            id="no_hp" name="no_hp" value="{{ old('no_hp', $user->profile->no_hp) }}"
                                            @required(true)>
                                        @error('no_hp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('password') is-invalid @enderror"
                                            ...
                                            value="{{ old('password') ? old('password', $user->password) : 'password' }}"
                                            @required(true)>
                                        <small class="text-muted">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-append date" data-date-format="dd-mm-yyyy">
                                        <input class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                            type="text" readonly="" autocomplete="off" id="tanggal_lahir"
                                            name="tanggal_lahir"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select select2 @error('jenis_kelamin') is-invalid @enderror"
                                            id="jenis_kelamin" name="jenis_kelamin" @required(true)>
                                            <option value=""></option>
                                            <option {{ $user->profile->jenis_kelamin == 'laki-laki' ? 'selected' : '' }}
                                                value="laki-laki"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select select2 @error('role') is-invalid @enderror"
                                            id="role" name="role" @required(true)>
                                            <option value=""></option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        @if ($user->profile->image)
                                            <img src="{{ asset('assets/images/users/' . $user->profile->image) }}"
                                                alt="Gambar Pengguna" class="img-thumbnail" width="60">
                                        @endif
                                    </div>
                                </div>
