        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                if (Gate::allows('update konfigurasi/roles')) {
                    $actionBtn .= '<button type="button" name="edit" data-id="' . $row->id . '" class="editRole btn btn-warning btn-sm me-2"><i class="ti ti-pencil"></i></button>';
                }
                if (Gate::allows('delete konfigurasi/roles')) {
                    $actionBtn .= '<button type="button" name="delete" data-id="' . $row->id . '" class="deleteRole btn btn-danger btn-sm"><i class="ti ti-trash"></i></button>';
                }
